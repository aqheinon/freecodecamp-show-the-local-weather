...
var riseHrs = sunrise.getHours();
var riseMins = "0" + sunrise.getMinutes();
var setHrs = sunset.getHours();
var setMins = "0" + sunset.getMinutes();
var formattedSunrise = riseHrs + ':' + riseMins.substr(-2);
var formattedSunset = setHrs + ':' + setMins.substr(-2);
  $(".description").html(json.weather[0].description);
  var temp = [(json.main.temp).toFixed(0), (1.8 * (json.main.temp) + 32).toFixed(0), (json.main.temp_min).toFixed(0), (json.main.temp_max).toFixed(0), (1.8 * (json.main.temp_min) + 32).toFixed(0), (1.8 * (json.main.temp_max) + 32).toFixed(0)];
  $(".celsius").html(temp[0] + " °C");
  $(".fahrenheit").html(temp[1] + " °F");
  $(".celsius-min").html(temp[2]);
  $(".celsius-max").html(temp[3] + " °C");
  $(".fahrenheit-min").html(temp[4]);
  $(".fahrenheit-max").html(temp[5] + " °F");
  ...
  $("button").click(function() {
    ...
    $(".fahrenheit").toggle();
    $(".celsius-min").toggle();
    $(".fahrenheit-min").toggle();
    $(".celsius-max").toggle();
    $(".fahrenheit-max").toggle();
  });
  $(".location").html(" in " + json.name + ", " + json.sys.country);
...
// geolocation and API request

window.onload = function() {
  var lat, lon, currentPos;
